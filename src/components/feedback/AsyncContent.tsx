...
import type { ListenerStatus } from '@/app/store';
import { EmptyState, type EmptyStateProps } from './EmptyState';
import { ErrorState } from './ErrorState';
import { LoadingState } from './LoadingState';

export interface AsyncContentProps {
  /** Shared Firestore listener status ('idle' | 'loading' | 'ready' | 'error'). */
...
/**
 * One switch from a Firestore listener's {@link ListenerStatus} to the shared
 * loading / empty / error / retry feedback (RM-300). Feature routes (Phase 4–5)
