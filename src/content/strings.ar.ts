...
export const strings = {
  dailyDua: {
    title: 'دعاء اليوم',
    settingsTitle: 'أدعية اليوم',
    description:
      'يظهر دعاء بعد إتمام الصفحات. يتحدد بتاريخ توزيع الجولة، ويتغير مع كل يوم وتدور القائمة من البداية. حفظ القائمة يحدّث الأدعية لجميع الأعضاء.',
    add: 'إضافة دعاء',
    edit: 'تعديل الدعاء',
    remove: 'حذف الدعاء',
    text: 'نص الدعاء',
    empty: 'القائمة فارغة. لن يظهر دعاء اليوم حتى تضيف دعاءً وتحفظ القائمة.',
    save: 'حفظ قائمة الأدعية',
    invalid: 'أدخل نصاً لكل دعاء (حتى 12000 حرف)، بحد أقصى 100 دعاء و100000 حرف للقائمة.',
    conflict: 'عدّل مشرف آخر القائمة. احتفظ بنصك، ثم أعد تحميل القائمة قبل الحفظ.',
    reload: 'إعادة تحميل القائمة',
    reloadConfirm: 'سيتم استبدال تعديلاتك غير المحفوظة بالقائمة المنشورة.',
    deleteConfirm: 'حذف هذا الدعاء من القائمة؟ يُطبّق الحذف عند حفظ القائمة.',
  },
  common: {
    appName: 'خَتْمة',
    done: 'تم',
